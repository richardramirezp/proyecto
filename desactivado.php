      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"> Inactivos <?php echo $nombre;?></h1>
          </div>
          <div class="card-body">
          <br>
          ...
          <?php
            ...
            while ($fila = mysqli_fetch_array($sql)){?>
              <tr>
                ...
                <td>
                  <button type="button" class="btn btn-sm btn-warning actiEst" data-toggle="modal" data-target="#EliminarEst" data-idestudiante="<?php echo $fila['id_estudiante']; ?>" data-idcolegio="<?php echo $id_colegio; ?>" data-perfil="Activacion"><i class="fas fa-user-edit"></i></button>
                </td>
              </tr>
          <?php } ?>      
        </tbody>
...
<div class="modal fade "  id="EliminarEst" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Activar Estudiante</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <div class="activacion_est">
              <!--Contenido Del Cuerpo-->
        </div>
      </div>
    </div>
