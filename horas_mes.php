    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Reporte Por Mes</h1>
          <!-- DataTales Example -->
          ...
          <?php
            $consulta= "SELECT SUM(horas),voluntario.documento, voluntario.nombre,voluntario.apellido,voluntario.id_voluntario FROM reporte_voluntario LEFT JOIN pro_vol on pro_vol.id_pro_vol=reporte_voluntario.id_pro_vol LEFT JOIN voluntario ON voluntario.id_voluntario=pro_vol.id_voluntario WHERE  DATE_FORMAT(fecha,'%Y')=YEAR(NOW())  GROUP BY documento";
            ...
            while ($fila = mysqli_fetch_array($sql)){?>
              <tr>
                ...
                <td>
                  <a class="nav-link mes" href="" data-toggle="modal" data-target="#HorasMes" aria-expanded="true" aria-controls="collapseUtilities" data-id="<?php echo  $fila['4'];?>">
                    <span><?php echo $fila['2']; ?> <?php echo $fila['3']; ?></span>
                  </a>
                </td>
                <td>
                  <?php echo $fila['0']; ?>
...
<div class="modal fade "  id="CodigVol" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal fade "  id="HorasMes" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header"><h5>Reporte De Meses</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <div class="contenido_meses">
              <!--Contenido Del Cuerpo-->
        </div>
      </div>
