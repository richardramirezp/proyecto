      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <table id="listar" class="table table-striped table-bordered">
                  <thead>
                    <th colspan="4" style="text-align: center;"><h3>Inactivos</h3></th>
                    <tr>
                      <th>Documento</th>
                      <th>Nombre</th>
                      <th>Horas</th>
          ...
          <?php
            ...
            while ($fila = mysqli_fetch_array($sql)){?>
              <tr>
                ...
                <td>
                  <button type="button" class="btn btn-sm btn-warning actiVol" data-toggle="modal" data-target="#EliminarVol" data-idvoluntario="<?php echo $fila['0']; ?>" data-idprograma="<?php echo $fila['1']; ?>" data-perfil="Activacion"><i class="fas fa-user-edit"></i></button>
                </td>
              </tr>
          <?php } ?>      
        </tbody>
...
<div class="modal fade "  id="ModalCapa" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Codigo Programas</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal fade "  id="EliminarVol" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Activar Voluntario</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <div class="activacion_vol">
              <!--Contenido Del Cuerpo-->
        </div>
      </div>
    </div>
